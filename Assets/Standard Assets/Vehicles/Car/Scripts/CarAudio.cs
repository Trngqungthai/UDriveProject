    ...
    public class CarAudio : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            if (m_StartedSound && camDist > maxRolloffDistance*maxRolloffDistance)
            {
                ...
                {
                    m_HighAccel.volume = Mathf.Clamp((m_HighAccel.volume -= 0.3f * Time.deltaTime), 0.1f, 1f);
            ...
            if (m_StartedSound)
            {
                ...
                {
                    m_HighAccel.volume = Mathf.Clamp((m_HighAccel.volume -= 2.5f * Time.deltaTime), 0.1f, 1f);
                    if (m_HighAccel.volume <= 0)
                    {
                        m_HighAccel.volume = 0;
                    }
